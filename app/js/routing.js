four51.app.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
	...
	$routeProvider.
       ...
       /* when('/catalog', { templateUrl: 'partials/categoryView.html', controller: 'CategoryCtrl' }).*/
		...
		when('/builder', { templateUrl: 'partials/builderView.html', controller: 'BuilderCtrl' }).
		when('/proposals', { templateUrl: 'partials/collectionsView.html', controller: 'CollectionsCtrl' }).
		when('/reporting', { templateUrl: 'partials/collectionReportingView.html', controller: 'CollectionReportingCtrl' }).
		otherwise({redirectTo: '/proposals'});
}]);