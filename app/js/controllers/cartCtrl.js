four51.app.controller('CartViewCtrl', ['$scope', '$location', '$451', 'Order', 'OrderConfig', 'User', 'DocumentBuilder',
function ($scope, $location, $451, Order, OrderConfig, User, DocumentBuilder) {
    ...
    $scope.editCollection = function(collection, lineItemID) {
        $scope.Collection = {"SelectedDocuments":[],"CoverLetter":{"Editing":false},"Specs":{},"EditingLineItem":true,"LineItemID":lineItemID};
